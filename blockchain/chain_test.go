...
func (f fakeDB) FindBlock(string) []byte {
...
func (fakeDB) SaveBlock(string, []byte) {}
func (fakeDB) SaveChain([]byte)         {}
...
func TestBlockchain(t *testing.T) {
	...
	t.Run("Should restore blockchain", func(t *testing.T) {
		...
		dbStorage = fakeDB{
			fakeLoadChain: func() []byte {
				bc := &blockchain{Height: 2, NewestHash: "xx", CurrentDifficulty: 1}
